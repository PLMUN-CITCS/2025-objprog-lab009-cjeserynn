public class SwitchStatementDemo {
    public static void main(String[] args) {
        ...
        // Step 2: Declare Day Variable (Integer)
        int dayOfWeek = 4;

        // Step 3: Switch Statement for Day of the Week
        switch (dayOfWeek) {
            case 1:
        ...
        // Step 5: Declare Grade Variable (Character)
        char studentGrade = 'B';

        // Step 6: Switch Statement for Grade Evaluation
        switch (studentGrade) {
            case 'A':
